...
import com.zhibian.bianwanplatformbackend.model.enums.UserRoleEnum;
...
import com.zhibian.bianwanplatformbackend.mapper.UserMapper;
...
import static com.zhibian.bianwanplatformbackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public LoginUserVO getLoginUserVO(User user) {
        ...
        BeanUtil.copyProperties(user,loginUserVO);//hutool工具类BeanUtil类的copyProperties方法，把第一个对象属性复制给第二个对象
        return loginUserVO; //改了
    }
